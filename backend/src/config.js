...
const extraMetadata = {
  external_url: "https://weird-weapons.netlify.app", // Replace with your website or remove this line if you do not have one.
};
...
const ROYALTY_ADDRESS = "0xeB02242B879628336A67ACe667e6baefFA58B422"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0xeB02242B879628336A67ACe667e6baefFA58B422",]; // only update if you want to manually set the whitelisted addresses
