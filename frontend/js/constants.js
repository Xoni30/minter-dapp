...
const welcome_p = 'The WEIRD-weapons NFT Project is a decentralized, collection of only 200 unique backgrounds for weapons.';
...
const p_presale_mint_not_whitelisted = "You are not licensed for the pre-sale.. 😢";
const p_presale_mint_whitelisted = "You have a weapon license for the pre-sale! 🎉";
const p_presale_mint_already_minted = "You've already claimed your mints. Thank you! 🎉";
const p_public_mint = "No license needed. public weapons are now available! 🎉";
const button_presale_coming_soon = "Get on the licensing list";
const button_presale_mint_whitelisted = "Mint Your own decentralized weapon";
const button_presale_mint_not_whitelisted = "Get your license NOW!!";
const button_presale_already_minted = "Join The Community";
const button_public_mint = "Mint Your weapon!!";
